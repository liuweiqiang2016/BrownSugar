...
import com.alex.myapp.brownsugar.okhttp.OkHttpHelper;
import com.alex.myapp.brownsugar.okhttp.UIProgressResponseListener;
...
//            fileName = url.substring(url.lastIndexOf("/") + 1);
            fileName = AppUtils.APP_XML_NAME;
        } else {
            //若下载apk文件
            fileName = AppUtils.APP_DOWNFILE_NAME;
        }
